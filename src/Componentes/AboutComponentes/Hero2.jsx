  ...
  return (
    <div>
      <div
        className="  w-full  " 
      >
        <div className="py-12 w-full h-full   left-0  right-0 flex flex-col  justify-center items-center align-center">
          <h1 className="text-center text-[#9d1f60]  font-bold text-6xl rubik-font" style={{textShadow:"4px 4px 4px white"}}>
            Who we are and what we do !
          </h1>
          <p className=" px-2 lg:px-0 mt-6 text-center text-xl    rubik-font" style={{textShadow:"4px 4px 4px white"}}>
